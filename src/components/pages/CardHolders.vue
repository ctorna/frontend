                        ...
                        <div class="row gutters-1">
                            <div class="col-12 col-sm-8">
                                <div class="product-details-content p-dec-content-edit">
                                    <h2 class="uppercase">Business Card Holder</h2>
                                    ...
                                    <div class="product-details-peragraph">
                                        <ul>
                                            <li>Made of Premium italian water resistant stock on sustainable wood.</li>
                                            <li>Special price of Rs. 99 if you order it with chhapai business cards.</li>
                                            <li>Get it personalised with your logo or name emgraved on it. At no extra cost.</li>
                                        </ul>
                                        <p class="mt-3">This service is for INR 5999 if ordered with business cards</p>
                                    </div>
                                    <h3><span class="actual-price">₹400.00</span> ₹99.00</h3>
                            ...
                            <div class="tab-content description-review-bottom">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7 col-lg-8">
                                                <div class="product-dec-content">
                                                    ...
                                                    <p>The most basic need for business cards are card holders!  The card holders we provide are at a special price for all our clients purchasing business cards. These card holders are- both portable and stationery for office use! This will add an immense volume to your professionalism and your brand recognition. The materials used are diverse and robust with personalized message and information on it. When you look at it, it will itself show how elegant of a material it is! And the touch is flawless with an eye-captivating design and color.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="des-details2" class="tab-pane">
                                    <div class="additional-info">
                                        ...
                                        <ul>
                                            <li><span>Weight</span> 500 gm</li>
                                        </ul>
                                    </div>
                                </div>
                                <div id="des-details3" class="tab-pane ">
                                    <div class="review-wrapper">
                                        <h3 class="mb-3">1 reviews for Business Card Holder</h3>
                                            ...
                                            <div class="review-content">
                                                <div class="review-top-wrap">
                                                    <div class="review-name">
                                                        <h5><span>Hardik K.</span> - December 20, 2019</h5>
                                                    </div>
                                                ...
                                                <p>It turned out to be damaged.</p>
                                            </div>
                                        </div>
                                    </div>
