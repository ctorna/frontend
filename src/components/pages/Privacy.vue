              ...
              <div class="row">
                <div class="col-lg-6 col-md-6">
                  <div class="single-faq-wrap mb-30">
                    ...
                    <p
                      class="mb-3"
                    >When you browse our store, we also automatically receive your computer’s internet protocol (IP) address in order to provide us with information that helps us learn about your browser and operating system.</p>
                  ...
                  <div class="single-faq-wrap mb-30">
                    ...
                    <p>If after you opt-in, you change your mind, you may withdraw your consent for us to contact you, for the continued collection, use or disclosure of your information, at anytime, by contacting us at orders.genie@gmail.com or mailing us at: Genie Prints Pvt Ltd 163 industrial area phase 1, chandigarh, CH, 160002, India</p>
                  </div>
                  <div class="single-faq-wrap mb-30">
                    <h3>Disclosure</h3>
                  ...
                  <div class="single-faq-wrap mb-30">
                    ...
                    <p
                      class="mb-3"
                    >As an example, if you are located in Canada and your transaction is processed by a payment gateway located in the United States, then your personal information used in completing that transaction may be subject to disclosure under United States legislation, including the Patriot Act.</p>
                    <p
                      class="mb-3"
                ...
                <div class="col-lg-6 col-md-6">
                  <div class="single-faq-wrap mb-30">
                    ...
                    <p
                      class="mb-3"
                    >Here is a list of cookies that we use. We’ve listed them here so you can choose if you want to opt-out of cookies or not.</p>
                    <p
                      class="mb-3"
                    >_session_id, unique token, sessional, Allows Chhapai to store information about your session (referrer, landing page, etc).</p>
                    <p
                      class="mb-3"
                    >cart, unique token, persistent for 2 weeks, Stores information about the contents of your cart.</p>
                    <p class="mb-3">_secure_session_id, unique token, sessional</p>
                  ...
                  <div class="single-faq-wrap mb-30">
                    ...
                    <p class="mb-3">
                      ...
                      <a href="mailto:orders.genie@gmail.com">orders.genie@gmail.com</a> or by mail at Genie Prints Pvt Ltd
                    </p>
                    <h4 class="mb-3">[Re: Privacy Compliance Officer]</h4>
                    <h4>[163 industrial area phase 1, chandigarh, CH, 160002, India]</h4>
                  </div>
                </div>
              </div>
            </div>
