            ...
            <div class="view-demo-aside-active">
                <div class="view-demo-wrap">
                    <div class="view-demo-tab-list nav">
                        ...
                        <a href="#view-demo-3" data-toggle="tab">
                          Demo Group 03
                      </a>
                    </div>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="product-details-content">
                                    ...
                                    <div class="product-details-peragraph">
                                        <p>Donec accumsan auctor iaculis. Sed suscipit arcu ligula, at egestas magna molestie a. Proin ac ex maximus, ultrices justo eget, sodales orci. Aliquam libero ac turpis pharetra, in vehicula scelerisque. Vestibulum
                                            ut sem laoreet, feugiat tellus at, hendrerit arcu.</p>
                                    </div>
